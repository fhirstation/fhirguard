from fhirguard_core.resources import Resource, Element
from typing import List

def query_resource(resource: Resource | Element, path: str) -> List[Resource | Element | str]:
...
def _recursive_query(labels: list[str], resource: Resource | Element) -> List[Resource | Element | str]:
    """"""
    if not labels:
        return [resource]
