from fhirguard_core.resources import Patient, CodeableConcept, Coding
...
def test_query_resource_nested_path():
    """"""
    patient = Patient.construct(id="123", maritalStatus=CodeableConcept.construct(
        coding=[Coding.construct(code="A", display="Annulled")],
        text="Annulled"
    ))
...
def test_query_resource_multiple_results_simple_object():
    """
    """
    patient = Patient.construct(id="123", maritalStatus={
        "coding": [
